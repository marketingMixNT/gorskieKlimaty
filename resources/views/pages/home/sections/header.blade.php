...
<header id="header"
    class=" text-center relative flex flex-col justify-center items-center h-[calc(100vh-180px)]  mt-[84px] sm:mt-0 w-full bg-cover bg-center bg-gray-400 bg-blend-multiply text-fontLight bg-2">
    <!--HEADING-->
